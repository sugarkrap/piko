...
/*
 * Function irda_getname (sock, uaddr, peer)
 *
 ...
 *
 */
static int irda_bind(struct socket *sock, struct sockaddr_unsized *uaddr,
		     int addr_len)
{
	struct sock *sk = sock->sk;
 ...
 */
static int irda_connect(struct socket *sock, struct sockaddr_unsized *uaddr,
