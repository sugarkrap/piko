...
/*
 * piko_blink -- defined in arch/arm/kernel/setup.c. This bootstrap kernel
 * has no console of any kind, so a single LED blink here on entry to
 * start_kernel() is kept as a minimal "kernel is alive" heartbeat. This is
 * the sole surviving call site of the piko_blink() diagnostic instrumentation
 * added during the 2026-07-29 mtd1 bootstrap-boot bring-up.
 */
...
void start_kernel(void)
{
	...
	/* Heartbeat: kernel entry reached. */
	piko_blink(1);
