...
static int lib80211_tkip_michael_mic(struct crypto_shash *tfm_michael, u8 *key, u8 *hdr,
				     ...
				     void *priv)
{
	...
	pos = skb_put(skb, 8);
	if (lib80211_tkip_michael_mic(tkey->tx_tfm_michael, &tkey->key[16], tkey->tx_hdr,
					...
					int hdr_len, void *priv)
{
	...
	if (lib80211_tkip_michael_mic(tkey->rx_tfm_michael, &tkey->key[24], tkey->rx_hdr,
