/*
 * md5.h -- minimal, dependency-free MD5 (RFC 1321) implementation shared by
 * userspace/src/md5sum.c and userspace/src/piko-update.c. Header-only/static
 * so either tool can #include it standalone with no separate link step,
 * matching the rest of userspace/src's one-file-per-tool convention.
 */
#ifndef PIKO_MD5_H
#define PIKO_MD5_H
...
/* Per-round shift amounts and the K table, both from RFC 1321 sec. 3.4. */
...
/* Formats digest as a 32-char lowercase hex string + NUL into out[33]. */
