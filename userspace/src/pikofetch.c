/*
 * pikofetch -- minimal system-info banner for the Zaurus, with a
 * hand-converted 3-tone ASCII portrait (Utatane Piko) instead of a
 * distro logo. Inspired by fastfetch, not a build of it -- the real
 * project is too heavy to cross-build cleanly for this ARMv5TE/
 * uClibc-ng/no-FPU target, so this is a small purpose-built
 * reimplementation covering the same idea.
 */
#include <stdio.h>
#include <stdlib.h>
#include <string.h>
