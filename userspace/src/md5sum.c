 ...
 * count. This is a small, dependency-free, from-scratch implementation of
 * the MD5 message-digest algorithm as specified in RFC 1321, plus a CLI
 * that mimics `md5sum FILE [FILE...]` output ("<hex digest>  <filename>"),
 * matching GNU/busybox md5sum so it's a drop-in on both ends.
 *
