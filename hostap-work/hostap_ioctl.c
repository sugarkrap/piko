...
static const iw_handler prism2_handler[] =
{
	...
	/* iw_handler_{set,get}_{spy,thrspy}() removed from current mainline
	 * along with the rest of the iwspy plumbing (see hostap_80211_rx.c,
	 * hostap_main.c) — SIOCxIWSPY/THRSPY are simply unhandled now. */
