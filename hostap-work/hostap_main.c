...
/* header_ops.parse() gained a 'dev' parameter in current mainline. */
		      ...
		      int type)
{
	...
	/* kernel callbacks */
	/* struct iw_public_data / net_device.wireless_data (iwspy plumbing)
	 * were removed from current mainline; see hostap_80211_rx.c. */
